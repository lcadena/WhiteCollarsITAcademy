...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		List<PictureDTO> pictures = controller.getAllPictures();
		...
		controller.addPicture("La Mona Lisa", "Da Vinci", 100.5, "18/2/2010");
		controller.addPicture("El Grito", "Munch", 89.99, "18/2/2010");
		List<PictureDTO> pictures2 = controller.getAllPictures();
		for(PictureDTO p : pictures2) {
			System.out.println("---------------------");
			System.out.println(p.getValues());
		}
		System.out.println(controller.getShopName());
